...
class HRApplicationTests {
	...
	public void setupEmpTestCase() {
		...
		//Employee.DEFAULT_ZERO; // <Class_Name>.<static Member>
		ex1 = new Employee();
		ex1.setEmpno(1002);
		ex1.setName("Example ");
	...
	void testSendAnnouncementToEmployees() {
		// we cannot create an object of abstract using new keyword
	...
	void testShapeExample() {
		...
		System.out.println("Rectangle Area: "+shRect.getParameter());
		
		System.out.println("Circle Area: "+shCircle.getArea());
		System.out.println("Circle Area: "+shCircle.getParameter());
