...
public class ExceptionExample {
	...
	public static void main(String[] args) {
		...
		try {
			...
			num1 = Integer.parseInt(sc.nextLine()); //fetch the String from console and parse to integer.
		...
		System.out.println("Division is: "+result);
		} catch (NumberFormatException e) { // handle specific scenarios of exception.
			...
			System.err.println("Exception Occurred: "+ex); // print the exception with message.
