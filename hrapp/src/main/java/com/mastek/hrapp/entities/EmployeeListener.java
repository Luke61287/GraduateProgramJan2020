...
public class EmployeeListener {
	...
	@PostPersist // call this method before inserting each emp object in employee table.
	...
	@PreRemove  // call this method after removing each emp object in employee table.
